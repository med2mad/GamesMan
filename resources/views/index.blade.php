...
@include( 'partials.hero' )
		...
		<!-- Start Help Us Section div1 div2 -->
		...
		<!-- Start Our goal Section div3 div4 -->
		<div class="we-help-section">
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-7 mb-5 mb-lg-0 div3">
						<div class="imgs-grid">
		...
		<!-- End Oul goal Section -->

		<!-- Start Help Us Section div5 div6 -->
		<div class="why-choose-section" style="padding: 2rem 0 0 0;">
			<div class="container">
				<div class="row justify-content-between">

					<div class="col-lg-6 div5">
						<h2 class="section-title">Help  preserve webgames</h2>
						...
						<div class="row my-5">
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									<div class="icon">
										<img src="/images/home/support.png" alt="Image" class="imf-fluid">
									</div>
					...
					<div class="col-lg-5 div6">
						<div class="img-wrap">
							<img src="/images/home/hq720.jpg" alt="Image" class="img-fluid">
						</div>
					</div>
		...
		<script>
			document.addEventListener("DOMContentLoaded", (event) => {
				...
				gsap.from(document.querySelectorAll('.div5'), {
					xPercent:-70,
					opacity:0,
					scrollTrigger:{trigger:'.div5', start:"top 100%", end:'bottom 90%', scrub:true}
				});
				gsap.from(document.querySelectorAll('.div6'), {
					xPercent:70,
					opacity:0,
					scrollTrigger:{trigger:'.div6', start:"top 100%", end:'bottom 90%', scrub:true}
				});
